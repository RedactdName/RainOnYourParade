...
//        /**/let h1El = document.createElement('weather-container');//*'h1'*/ /*changed from h1 to weather container to style font differently from head elements*/
//         /**/let h2El = document.createElement('weather-container');/*'h2'*/
...
eventContainerSectionEl.setAttribute('class','event-holder')
    ...
    for (let i = 0; i < data.events.length; i++) {
        ...
        //creating the list item and adding text content
        let h1El = document.createElement('h1'); /*h1*/
        let h2El = document.createElement('h2'); /*h2*/
        h1El.textContent = eventName;
        h1El.setAttribute('class', 'event-name')
        h2El.textContent = eventDateTime.split('T')
        h2El.setAttribute('class', 'event-date-time')
